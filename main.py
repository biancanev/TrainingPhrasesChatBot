...
month = ["January", "February", "March", "April", "June", "July", "August", "September", "October", "November", "December", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"]
def genDate(dateType):
  if dateType == 1:
    ...
    return (month[random.randint(0,23)] + str(random.randint(1,31) + ", 2021"))
  elif dateType == 5:
...
def cat1(number, objectParam, dateType):
  ...
  objectQuestions = ["Give me the {" + attributeItem + "|modification|attribute} of the {" + inventoryItem + "|class|primary} that were associated to {" + objectItem + "|object|secondary} on {" + timeItem + "}", "Show me the {" + attributeItem + "|modification|attribute} of the {" + inventoryItem + "|class|primary} that were associated to {" + objectItem + "|object|secondary} on {" + timeItem + "}", "I want access the {" + attributeItem + "|modification|attribute} to the {" + inventoryItem + "|class|primary} that were associated to {" + objectItem + "|object|secondary} on {" + timeItem + "}", "Show me the {" + attributeItem + "|modification|attribute} of the {" + inventoryItem + "|class|primary} pertaining to {" + objectItem + "|object|secondary} on {" + timeItem + "}", "Give me the {" + attributeItem + "|modification|attribute} of the {" + inventoryItem + "|class|primary} pertaining to {" + objectItem + "|object|secondary} on {" + timeItem + "}", "I want access to the {" + attributeItem + "|modification|attribute} of the {" + inventoryItem + "|class|primary} pertaining to {" + objectItem + "|object|secondary} on {" + timeItem + "}", "Open information on the {" + attributeItem + "|modification|attribute} of the {" + inventoryItem + "|class|primary} pertaining to {" + objectItem + "|object|secondary} on {" + timeItem + "}"]
  if objectParam == "none":
...
def cat5(number, objectParam, dateType):
  ...
  for iteration in range(number):
    data.append(questions[random.randint(0, len(questions)-1)])
  return data
def genQuestions(category1=0, category2=0, category3=0, category4=0, category5=0, objectParam="none", objectList=[], dateType=5):
